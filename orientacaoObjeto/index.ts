 ...
 */
 ...
 const arrayFilme: string[] = ["Filme1","filme2"]
...
const arrayJogo: string[] = ["Celeste","Hollow Knight","Undertale","Portal"]

function addJogo(a:string[],b:string){
    console.log(a);
    a.push(b)
    return a;
...
let doubleEvenNumbers: number[]

function dobrarParesMenoresQuecinco(a: number[]){
   doubleEvenNumbers = a.filter(i => i % 2 === 0 && i < 5)

   doubleEvenNumbers = doubleEvenNumbers.map(i => i * 2)
